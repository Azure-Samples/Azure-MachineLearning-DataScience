This folder contains pySpark notebooks for published data science walk-throughs in Spark using HDInsight cluters. There are 3 notebooks for Spark 1.6, and one for Spark 2.0.
