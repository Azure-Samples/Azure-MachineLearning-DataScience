...
###########################################
#sparkEnvir <- list(spark.executor.instance = '12', spark.yarn.executor.memoryOverhead = '2048', spark.driver.memory = '12g')
sc <- sparkR.session(
...
trainDF <- SparkR::filter(dfrand, dfrand$randnum <= 0.75)
testDF <- SparkR::filter(dfrand, dfrand$randnum > 0.75)
```
